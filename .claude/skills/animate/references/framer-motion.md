...
The `motion` package (successor to framer-motion) is the recommended animation library for React/Next.js applications. Import from `"motion/react"` for React components and hooks.
