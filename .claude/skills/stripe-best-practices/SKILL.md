...
description: "Guides Stripe integration decisions: API selection (Checkout Sessions vs `PaymentIntents`), Connect platform setup, billing/subscriptions, Treasury financial accounts, and migrating from deprecated Stripe APIs. Use when building, modifying, or reviewing any Stripe integration."
---
