 ...
 *
 * Usage: pnpm dlx tsx action_usage_analyzer.ts [workflow-dir]
 *
 * Examples:
 *   pnpm dlx tsx action_usage_analyzer.ts .github/workflows
 *
...
if (require.main === module) {
  ...
  if (!fs.existsSync(dir)) {
    ...
    console.error('\nUsage: pnpm dlx tsx action_usage_analyzer.ts [workflow-dir]');
    console.error('Example: pnpm dlx tsx action_usage_analyzer.ts .github/workflows');
    process.exit(1);
  }
