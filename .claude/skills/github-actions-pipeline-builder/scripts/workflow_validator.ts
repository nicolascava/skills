 ...
 *
 * Usage: pnpm dlx tsx workflow_validator.ts [workflow-file]
 *
 * Examples:
 *   pnpm dlx tsx workflow_validator.ts .github/workflows/ci.yml
 *   pnpm dlx tsx workflow_validator.ts .github/workflows/*.yml
 *
...
if (require.main === module) {
  ...
  if (args.length === 0) {
    console.log('Usage: pnpm dlx tsx workflow_validator.ts <workflow-file>');
    console.log('\nExamples:');
    console.log('  pnpm dlx tsx workflow_validator.ts .github/workflows/ci.yml');
    console.log('  pnpm dlx tsx workflow_validator.ts .github/workflows/*.yml');
    process.exit(1);
  }
